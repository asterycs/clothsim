...
namespace clothsim
{
    ...
    UI::UI(const Vector2i windowSize, const Vector2i framebufferSize, const Vector2 scaling, App& app)
        : m_app{app}, m_imgui{NoCreate}, m_currentWindowSize{windowSize}, m_currentFramebufferSize{framebufferSize},
